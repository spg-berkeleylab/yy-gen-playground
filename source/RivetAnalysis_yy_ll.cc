...
namespace Rivet {
  ...
  public:
    ...
    void init() {
      ...
      book(_histMultLowEta , "MultLowEta", 100, -0.5, 99.5);
/*    //examples
...
*/
    ...
    void finalize() {
      ...
      normalize(_histMultLowEta, normfac);
    ...
    Histo1DPtr _histMult, _histEta, _histRapidity, _histPt, _histE, _histPhi, _histMultLowEta, _histPtLowEta;
